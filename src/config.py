...
class StartScreen(tk.Tk):
    ...
    LIMITATIONS:
        ...
        2. The selection of the OS has to be done manually and is not
            automatically detected.
        3. The selection of the difficulty has to be done after every game.
    ...
    OUTPUT:
        ...
        the size of the playing field, and the difficulty of the game. The
        window is closed when the player has made her/his selection.
    """
    ...
    def __init__(self):
        ...
        DESCRIPTION:
            ...
            self.title, self.geometry, and self.resizable are tkinter options
            that are set to our liking.

            self.ROWS and self.COLUMNS are the attributes that contains the
            size of the board.

            self.OS contains the value for the OS version. This value is added 
            to account for the fact that macOS and windows have different right
            mouse buttons.
        """
    ...
    def set_row_col(self):
        ...
        DESCRIPTION:
            ...
            selection the player made for the size of the playing field with
            the radio buttons generated by the set_playing field function.
        """
    ...
    def new_difficulty_level_window(self):
        ...
        DESCRIPTION:
            ...
            the creation of the board based on the settings the player
            selected. Either the function easy, normal or hard is called.
        """
