...
StartScreen (class):
    ...
    the difficulty of the game.
        ...
        set_playfield (function) - Makes radio buttons which allows the
            ...
            The selection changes the attributes of the class.
        set_row_col (function) - Changes the ROWS and COLUMNS attribute of
            the class, based on the selection the player made for the size
            of the playfield with the radio buttons generated by the
